...
# 3) Let's call a method, and pass both a string and an array as arguments and see how even though they are treated
...
# += is assignment which is non mutating.  << is mutating.
...
# I understand. Reassignment is not mutating.
...
#vand my_array should be set to ['pumpkins', 'rutabaga']
